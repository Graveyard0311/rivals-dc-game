...
Default movement/ability keys can be rebound from **Settings & Keybinds** on the hero-select screen. FOV, mouse sensitivity, master volume, and health-bar visibility are saved locally.
